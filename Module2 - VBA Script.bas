    ...
    For Each ws In Worksheets
        ...
        LastRowA = ws.Cells(Rows.Count, 1).End(xlUp).Row
            ...
            For i = 2 To LastRowA
                ...
                ws.Cells(TickCount, 10).Value = ws.Cells(i, 6).Value - ws.Cells(j, 3).Value
                    ...
                    'Calculate percent change in column K (#11)
        ...
        GreatDecr = ws.Cells(2, 11).Value
            ...
            For i = 2 To LastRowI
                ...
                'For greatest decrease if next value is smaller--if yes move new value and populate ws.Cells
